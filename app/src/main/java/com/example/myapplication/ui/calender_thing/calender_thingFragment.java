...
public class calender_thingFragment extends Fragment {
    ...
    public static calender_thingFragment newInstance() {
        return new calender_thingFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_calender_thing, container, false);
    }
